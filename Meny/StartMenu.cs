...
namespace Hobby_projekt
{
    class StartMenu
    {
        ...
        public StartMenu(GameStateManager stateManager)
        {
        ...
        public void Update()
        {
            ...
            mouseRect = new Rectangle((int)(mouseState.Position.X/2), (int)(mouseState.Position.Y), (int)mouseRect_Size.X, (int)mouseRect_Size.Y);
        ...
        public void Draw(SpriteBatch sb)
        {
            ...
            sb.Draw(Game1.texture, mouseRect, Color.White);
